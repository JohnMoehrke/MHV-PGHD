...
InstanceOf: MHVbundleBluebutton
...
* entry[MHVcompositionBluebutton].resource = ex-MHV-Composition-0
* entry[Patient].resource = ex-patient
* entry[2].resource = ex-MHV-weight
* entry[3].resource = ex-MHV-bloodSugar-0
